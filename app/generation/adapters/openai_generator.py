...
_CLOSED_BOOK_SYSTEM_PROMPT = (
    ...
    "Khi nói nguồn không có hoặc không đủ thông tin được hỏi, phải trích dẫn "
    "ngay các nguồn đã kiểm tra cho nhận định giới hạn đó. "
...
_OPEN_BOOK_SYSTEM_PROMPT = (
    ...
    "nào là kiến thức chung. Khi nói nguồn không có hoặc không đủ thông tin "
    "được hỏi, phải trích dẫn ngay các nguồn đã kiểm tra cho nhận định giới hạn đó. "
    "Mỗi khi dùng thông tin từ một nguồn, hãy chèn "
