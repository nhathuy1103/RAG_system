...
- CONDITIONAL_FACT: {"citation_support": 1.0, "count": 30, "evidence_recall_at_10": 1.0, "fact_f1": 1.0}
- CONFLICT_CHECK: {"citation_support": 1.0, "count": 30, "evidence_recall_at_10": 1.0, "fact_f1": 1.0}
- CURRENT_FACT: {"citation_support": 1.0, "count": 30, "evidence_recall_at_10": 1.0, "fact_f1": 1.0}
- DEFAULT_FACT: {"citation_support": 1.0, "count": 30, "evidence_recall_at_10": 1.0, "fact_f1": 1.0}
- DUPLICATE_HEAVY: {"citation_support": 1.0, "count": 30, "evidence_recall_at_10": 1.0, "fact_f1": 1.0}
- HISTORICAL_FACT: {"citation_support": 1.0, "count": 30, "evidence_recall_at_10": 1.0, "fact_f1": 1.0}
- NO_ANSWER: {"citation_support": 1.0, "count": 30, "evidence_recall_at_10": 1.0, "fact_f1": null}
- TEMPORAL_COMPARISON: {"citation_support": 1.0, "count": 30, "evidence_recall_at_10": 1.0, "fact_f1": 1.0}
...
- Raw/post-relation/final tokens: 4110 / 3060 / 3060
...
- baseline_proxy_p50: 0.11905
- baseline_proxy_p95: 0.13723
- p5_total_p50: 0.2447
- p5_total_p95: 0.313995
- incremental_bookkeeping_p50: 0.13005
- incremental_bookkeeping_p95: 0.175505
...
- raw_context_tokens: 4110
- post_relation_tokens: 3060
- final_context_tokens: 3060
- output_tokens_estimated: 3450

## Ablation

- method: "Measured layer outcomes and deterministic policy slices; these are not claimed as causal model-quality estimates."
- A_hybrid_only: {"context_tokens": 4110, "evidence_precision": 0.7083333333333334, "evidence_recall": 1.0}
- B_plus_reranker: {"context_tokens": 4110, "evidence_precision": 0.7083333333333334, "evidence_recall": 1.0}
- C_plus_p4_relation_policy: {"context_tokens": 3060, "duplicate_redundancy": 0.0625, "evidence_precision": 0.9375, "evidence_recall": 1.0}
- D_plus_temporal_version: {"context_tokens": 3060, "evidence_recall": 1.0, "fact_f1": 1.0, "temporal_accuracy": 1.0}
